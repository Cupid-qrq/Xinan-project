...
::::{card} 🖥️ GUI
:link: ./gui/0_gui
Use CoPyRIT — the graphical interface for human-led red teaming.
::::

::::{card} 💻 CLI & Shell
:link: ./front_end/0_front_end
Use `pyrit_scan` and `pyrit_shell` for automated and interactive assessments.
::::
